<section class="detail_section margin-top-20 need-con-list">
	<p class="need-con-list-tit <?php if (count($res) < 1){echo 'hide';}?>">相似需求：<?php echo count($res);?>条</p>
	<div class="detail_need_list_wrap detail_need_list_wrap1 <?php if (count($res) < 1){echo 'hide';}?>">
		<ul class="need-list-wrapper">
		<?php foreach ($res  as $key=>$val){?>
		   <?php if ($val['demand_type'] == 1){?>
                  <li>
                		<a href="javascript:godemandshow('<?php echo $val['_id'];?>')" data-ajax=false>
...
<!-- 需求发布者发布的其他需求 -->
<section class="detail_section margin-top-20 need-con-list">
	<p class="need-con-list-tit <?php if (count($resMy) < 1){echo 'hide';}?>">需求发布者发布的其他需求：<?php echo count($resMy);?>条</p>
	<div class="detail_need_list_wrap detail_need_list_wrap1 <?php if (count($resMy) < 1){echo 'hide';}?>">
		<ul class="need-list-wrapper">
					<?php foreach ($resMy  as $key=>$val){?>
		   <?php if ($val['demand_type'] == 1){?>
                  <li>
                		<a href="javascript:godemandshow('<?php echo $val['_id'];?>')" data-ajax=false>
                			<div class="need_item_top layout">
