...
<section data-role="page" id="privateLetterSend" data-title="方橙-最专业的招商选址大数据平台" class="contain <?php if ($page!=1){echo 'hide';} ?>">
    <header data-role="header" data-theme="b" class="header ui-header ui-bar-b" role="banner">
        ...
        <h1 class="ui-title" role="heading" aria-level="1">精选品牌</h1>
    </header>
    <div data-role="content" class="detail_content ui-content">
        ...
        <section class="detail_section padding-top-10 padding-bottom-10 gray_bg">
            <div class="btn_box join-tv width80">
                <a href="/chengtv/add/recomm/1"  class="btn add-need-btn ui-link" data-ajax="false"><span class="layout layout-align-center-center">报名加入品牌推荐</span></a>
            </div>
        </section>
        <section class="detail_section">
            <div class="detail_section_main2">
                <div class="tv-wrap <?php if (count($list) <= 0){echo 'hide';}?>">
                ...
                <div class="detail_noData <?php if (count($list) > 0){echo 'hide';}?>">
                    <p>当前条件暂无结果，换个业态看看</p>
                </div>
...
<form id="data-form" action="/recommend/brand" method="post" class="hide">
