...
<section data-role="page" id="need-two" data-title="方橙-最专业的招商选址大数据平台" class="contain" data-role="none">
    <header data-role="header" data-theme="b" class="header">
        <a href="#need-one" data-transition="slide" data-direction="reverse" class="nav-icon-back" class="nav-icon-back">上一步</a>
        <h1>发布需求</h1>
    </header>
    <div data-role="content" class="detail_content brandNeedH5">
        <div class="detail_main dask-card-main">
            <div class="formwrapper">
                <h3 class="needFormTit1">上传品牌形象图片</h3>
                <p class="needFormTit">如店铺照、产品图或宣传图，640 x 480 以上</p>
                <div id="brandImage" validate-item="brandImage" class="brandNeedImgBox">
                    <div class="default brandNeedH5Img brandNeedH5ImgW640H480 layout layout-align-center-center">
                        <span class="brandNeedH5ImgNo">您还没有上传图片</span>
                    </div>
                    <div class="preview brandNeedH5Img brandNeedH5ImgW640H480 layout layout-align-center-center hide">
                    ...
                    <div class="layout uploadContainer">
                        <div class="flex layout layout-align-center-center padding-top-20">
                            <div class="fileinput-button-x fileinput-button btn_box btn_upload flex hide">
                                ...
                                <input type="file" class="avatarInput input-file avatar-input" ratio-w="640" ratio-h="480" text-container="#brandImage .btn" errormsg-container="#brandImage .tip" result-field="#brandImage .resultValue" preview-default-container="#brandImage .default" preview-container="#brandImage .preview" back-page="#need-two"/>
                            </div>
                            <div class="fileinput-button_wx fileinput-button btn_box btn_upload flex" ratio-w="640" ratio-h="480" text-container="#brandImage .btn" errormsg-container="#brandImage .tip" result-field="#brandImage .resultValue" preview-default-container="#brandImage .default" preview-container="#brandImage .preview" back-page="#need-two">
                                <div class="postcard_wx btn layout layout-align-center-center">上传图片</div>
                            </div>
                        </div>
                    </div>
                    <input class="resultValue" validate-field="brandImage" required-msg="请上传品牌形象图片" validate-type="required" type="hidden" name="brand_logo" />
                </div>
                <div class="form-item">
                    <p class="needFormTit">为品牌形象图片打上标签：</p>
                </div>
