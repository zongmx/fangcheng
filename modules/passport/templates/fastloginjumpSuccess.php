...
<section data-role="page" id="loginPage" data-title="方橙-最专业的招商选址大数据平台" class="contain register gray_bg">
    ...
    <section class="detail_content" data-role="content" role="main">
        ...
        <div class="detail_main formwrapper messageLogin " style="height:84%;">
            <form id="loginForm1" role="form" action="/passport/loginjump" method="post">
                        <div id="mobile" for="input" validate-item="mobile" class="form-item margin-top-10">
                            <div validate-ok="mobile" class="form-input-wrapper layout layout-align-start-center ui-field-contain" style="height:42px;">
                                ...
                                <div class="flex flex100">
                                    <input validate-blur="" validate-field="mobile" required-msg="请输入有效手机号" mobile-msg="您输入的手机号码格式错误，请重新输入！"  validate-type="required,mobile" type="tel" name="mobile" class="text-input" placeholder="请输入手机号"></div>
                            </div>
                        ...
                        <div class="layout form-item margin-bottom-30 posr">
                            ...
                            <div class="codeBox1 btn_box">
                                <input id="sendSmsBtn" type="button" class="newbtn" value="获取验证码" data-role="none"/>
                            </div>
                        </div>
            </form>
...
function tab(arg1,arg2,current){
    ...
    function sendSMS() {
        ...
        if(sendSMS.clickNum === 1){
            commonUtilInstance.smsAjax(mobileNumber,2,1,1,successInfo)
        }else {
            commonUtilInstance.smsAjax(mobileNumber,2,1,1,successInfo);
        }
