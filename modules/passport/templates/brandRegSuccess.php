...
<!-- 对话详情 start -->
<form id="registerform" method="post" action="/passport/dobrandreg">
<input type="hidden" name="passport_type" value="1">
            ...
            <div id="userNameField" class="form-item">
                <div class="layout form-item-uname">
                    ...
                    <div for="[name=passport_last_name]" class="form-input-wrapper form-item-secondName layout layout-align-start-center ui-field-contain flex">
                        ...
                        <input type="text" name="passport_last_name" class="text-input" onkeyup='commonUtilInstance.normal_word(this);' maxlength="10" placeholder="您的名字"/>
                    </div>
                </div>
                <div class="hide tip">
                </div>
...
<article data-role="page" id="registerThree" data-title="方橙" class="contain register">
    <header data-role="header" data-theme="b" class="header">
        <a href="#registerTwo" data-role="button" data-shadow="false" data-transition="slide" data-direction="reverse" class="padding-top-15">上一步</a>
        <h1>负责的品牌信息</h1>
    </header>
    <section class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div class="form-item layout layout-align-start-center">
					
                <div class="custom-add-h">继续新增负责的品牌？</div>
                <i class="custom-add">+</i>
            </div>
            <div class="form-item grayc8c">
                <p>方橙将为您负责的每个品牌寻找适合的商业体，其他用户可以在品牌页面上找到您</p>
            </div>
