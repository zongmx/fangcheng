...
<!-- 对话详情 start -->
<form id="registerform" method="post" action="/passport/dootherreg">
<input type="hidden" name="passport_type" value="4">
...
<article data-role="page" id="registerTwo" data-title="方橙" class="contain register">
    <header data-role="header" data-theme="b" class="header">
        <a href="#registerOne" data-role="button" data-shadow="false" data-transition="slide"
           data-direction="reverse" data-ajax="false" class="padding-top-15">上一步</a>
        <h1>基本信息</h1>
    </header>
    <scetion class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            ...
            <div for="[name=passport_job_title]" id="jobField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    <label class="text-label text-label-imgCode">*职位：</label>
                    <input type="text" name="passport_job_title" class="text-input" maxlength="50" placeholder="输入您所在的职位头衔"/>
                </div>
                <div class="hide tip">
                </div>
            </div>
    ...
    <section class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div class="form-item layout layout-align-start-center">
                <span class="custom-add-h">不止负责一个项目？</span>
