...
<!-- 对话详情 start -->
<form id="registerform" method="post" action="/passport/dobusinessregitem">
<input type="hidden" name="passport_type" value="3">
<input type="hidden" name="status" value="1">
<article data-role="page" id="registerOne" data-title="方橙" class="contain register">
    ...
    <scetion class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div for="[name=passport_email]" id="emailField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    ...
                    <input type="email" name="passport_email" class="text-input" maxlength="60" placeholder="输入您的常用邮箱"/>
                </div>
                <div class="hide tip">
                </div>
            </div>
            <input type="password" class="hide"/>
            <div for="[name=passport_password]" id="passwordField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    <label class="text-label text-label-password">*密码：</label>

                    <div class="flex">
                        <input type="password" name="passport_password" onkeyup="commonUtilInstance.password_word(this);" class="text-input" maxlength="60" placeholder="设置您的登录密码"/>
                    </div>
            ...
            <div for="[name=passport_mobile]" id="mobileField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    <label class="text-label text-label-mobile">*手机号：</label>
                    <input type="number" name="passport_mobile" class="text-input" maxlength="11" placeholder="输入您的手机号"/>
                </div>
                <div class="hide tip">
                </div>
            </div>

            <div for="[name=imageCode]" id="imgCodeField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    <label class="text-label text-label-imgCode">*图形验证：</label>
                    <input type="number" name="imageCode" class="text-input" maxlength="4" placeholder="输入下方的图形验证码"/>
                </div>
                <div class="hide tip">
                </div>
            </div>

            <div id="imgCode" class="form-item">
                <div class="form-input-wrapper form-item-imgCode layout layout-align-start-center ui-field-contain">
                    <img id='checkImgDis' class="imgcode captcha" src="/img/check.php">
                    <a href="javascript:;" class="input-aide">&nbsp;&nbsp;看不清</a>
                </div>
            </div>

            <div class="layout form-item">
                <div for="[name=mobileCode]" id="codeField">
                    <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                        <label class="text-label text-label-mobile">*短信码：</label>
                        <div class="flex">
							<input type="number" name="mobileCode" class="text-input" maxlength="11" placeholder="手机短信验证"/>
						</div>
                    </div>
                    <div class="hide tip">
                    </div>
                </div>
                <div class="codeBox btn_box flex">
                    <input id="sendSmsBtn" type="button" class="btn btn_full_disable" value="点击获取验证码" data-role="none"/>
                </div>
            </div>
            <div class="form-item form-checkbox-wrapper">
                <p>你从什么途径知道方橙的？</p>
                <ul id="channelField" class="cl">
                    <li>
                        <div class="check_auto">
                            <span>工作人员</span>
                            <input type="hidden" name="passport_channel_channel[]" />
                        </div>
                    </li>
                    <li>
                        <div class="check_auto">
            ...
            <div id="checkmeField" class="form-item form-reg-argen">
                <div class="layout">
                    ...
                    <a href="javascript:;" data-toggle="modal" custom-dialog="#regAgreement">《方橙用户协议、隐私权政策》</a>
                </div>
                <div class="hide tip">
                </div>
            </div>
            <div class="btn_box form-item layout">
                <a class="btn btn_full_able layout layout-align-center-center" href="#registerTwo" data-transition="slide">下一步</a>
            </div>
        </div>
    </scetion>
    <!-- 注册协议 -->
...
<article data-role="page" id="registerTwo" data-title="方橙" class="contain register">
    <header data-role="header" data-theme="b" class="header">
         <a href="#registerOne" data-role="button" data-shadow="false" data-transition="slide" data-direction="reverse" class="padding-top-15">上一步</a>
        <h1>基本信息</h1>
    </header>
    <scetion class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div id="userNameField" class="form-item">
                <div class="layout form-item-uname">
                    <div for="[name=passport_first_name]" class="form-input-wrapper form-item-fistName layout layout-align-start-center ui-field-contain">
                        <label class="text-label text-label-firstName">*姓：</label>
                        <input type="text" name="passport_first_name" class="text-input" onkeyup='commonUtilInstance.normal_word(this);' maxlength="10" placeholder="您的姓名"/>
                    </div>
                    <div for="[name=passport_last_name]" class="form-input-wrapper form-item-secondName layout layout-align-start-center ui-field-contain flex">
                        <label class="text-label text-label-second">*名：</label>
                        <input type="text" name="passport_last_name" class="text-input" onkeyup='commonUtilInstance.normal_word(this);' maxlength="10" placeholder="您的名称"/>
                    </div>
                </div>
                <div class="hide tip">
                </div>
            ...
            <div id="sexField" class="form-item">
                <div class="layout form-item-checkbox form-item-gender">
                    <div class="form-input-wrapper layout layout-align-start-center ui-field-contain flex boy text-ok"
                         value="1">
                        <i class="check_bg"></i>

                        <div class="check_tit">男性</div>
                    </div>
                    <div class="form-input-wrapper layout layout-align-start-center ui-field-contain flex girl"
                         value="2">
                        <i class="check_bg"></i>
                ...
                <input type="hidden" name="passport_sex" value="1"/>
            ...
            <div for='a' id="cityField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    ...
                    <a class="custom-select-header flex layout layout-align-start-center" href="#select-custom-city"
            ...
            <div for="[name=passport_company]" id="companyField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    <label class="text-label text-label-imgCode">*公司名：</label>
                    <input type="text" name="passport_company" class="text-input" onkeyup='commonUtilInstance.company_word(this);' maxlength="50" placeholder="输入您所在的公司名称"/>
                </div>
                <div class="hide tip">
                </div>
            </div>
            <div for="a" id="jobField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    ...
                    <a class="custom-select-header flex layout layout-align-start-center" href="#select-custom-job" data-transition="slide">
                            <div class="custom-select-name">选择您的职位头衔</div>
							
                        </a>
                    <i class="caret_right"></i>
                    <input type="hidden" name="passport_job_title"/>
                </div>
                <div class="hide tip">
                </div>
            </div>
            <div for="a" id="areaField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    ...
                    <a class="custom-select-header flex layout layout-align-start-center" href="#select-custom-city" data-transition="slide">
                            <div class="custom-select-name"><span>选择您负责的区域</span></div>
							
                        </a>
                    <i class="caret_right"></i>
                    <input _name="area_id" type="hidden" name="passport_area_area_id"/>
                    <input _name="area_other" type="hidden" name="passport_area_area_id_other"/>
                </div>
                <div class="hide tip">
                </div>
            </div>
            <div for="a" id="categoryField" class="form-item">
                <div class="form-input-wrapper layout layout-align-start-center ui-field-contain">
                    ...
                    <a class="custom-select-header flex layout layout-align-start-center" href="#select-custom-format" data-transition="slide">
                            <div class="custom-select-name"><span>选择您主要负责招商的业态</span></div>
            ...
            <div id="cardField" class="form-item">
                <div class="layout">
                    <div class="flex layout-column">
						...
						<div id="fileinput-button_wx" class="fileinput-button_wx btn_box btn_upload flex">
                            <div id="postcard_wx" class="btn btn_default layout layout-align-center-center">点击上传或拍摄名片</div>
                        </div>
                        <div class="layout layout-align-start-center progress-bar-height-5">
                ...
                <div id="imagePreview" class="margin-top-5 hide">
                    <img src="" class="imgRev"/>
                </div>
            </div>
            <div class="btn_box form-item layout">
                <a class="btn btn_full_able layout layout-align-center-center" href="#registerThree" data-transition="slide">下一步</a>
            </div>
        </div>
    </scetion>
</article>
<article data-role="page" id="registerThree" data-title="方橙" class="contain register">
    <header data-role="header" data-theme="b" class="header">
        <a href="#registerTwo" data-role="button" data-shadow="false" data-transition="slide"
           data-direction="reverse" class="padding-top-15">上一步</a>
        <h1>负责的商业体信息</h1>
    </header>
    <section class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div id="_mock_addMall" class="form-item layout layout-align-start-center">
                <span class="custom-add-h">不止负责一家商业体？</span>
...
<div class="hide modal_code" data-toggle="modal" custom-dialog="#login-dialog"></div>
<div id="login-dialog" role="dialog" class="modal fade myDodal">
    <div class="modal-backdrop fade on" style="height: 1716px;"></div>
    <div class="modal-dialog">
        <div class="modal-content formwrapper">
            <div class="modal-header">
                <button type="button" data-dismiss="modal" class="close ui-btn ui-shadow ui-corner-all hide"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                <h4 id="myModalLabel" class="modal-title">提示</h4>
            </div>
            <div class="modal-body form-item">
                <p>由于短信运营商的原因，您多次未成功接收到短信验证码。请确认您的手机号码为：</p>
                <p class="mobileSpan"></p>
                <p>您的一个手机号只能注册一个账号，且手机号将用于登录</p>
                <div class="form-group clearfix margin-top-20 btn_box">
                    <button type="button" class="btn btn_default codeError" data-dismiss="modal">号码不正确，返回修改号码</button>
                </div>
                <div class="form-group clearfix margin-top-20 btn_box">
                    <button type="button" class="btn btn_default codeNormal" data-dismiss="modal">号码无误，使用免验证注册</button>
                </div>
            </div>
        </div>
    </div>
