...
<input type="hidden" name="passport_type" value="2">
...
<article data-role="page" id="registerThree" data-title="方橙" class="contain register">
    ...
    <section class="detail_content" data-role="content" role="main">
        <div class="detail_main formwrapper">
            <div id="_mock_addMall" class="btn_box form-item layout submit">
                <a  class="btn btn_full_able layout layout-align-center-center">完成注册</a>
            </div>
        </div>
    </section>
</article>
