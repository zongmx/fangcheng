                    ...
                    <ul>
                        ...
                        <li data-nav="sort" class="sort-wrapper list-wrapper">
                            <ul id="searchSort" class="dropdown-list">
                                ...
                                <li data-value="m_res_3-desc" <?php if($sort == "m_res_3-desc"){}?> class="active"><?php }?> 面积最多</li>
                                <li data-value="m_res_3-desc" <?php if($sort == "m_res_3-desc"){?> class="active"><?php }?> 体量最多</li>
                                <li data-value="m_res_3-desc" <?php if($sort == "m_res_3-desc"){}?> class="active"><?php }?> 差旅最多</li>
                                <li data-value="m_res_3-desc" <?php if($sort == "m_res_3-desc"){}?> class="active"><?php }?> 最多</li>
                            ...
                            <div class="shop_search_item layout" onclick="javascript:location.href='/details/mall/mall_id/<?php echo $val['mall_id']; ?>'">
                                ...
                                <div class="shop_info flex layout-column">
                                    ...
                                    <div class="radil_info  <?php echo (empty($val['res_3']) && empty($val['office_3']) && empty($val['travel_3']))?'hide':'';?>">
                                        ...
                                        <?php }?>
                                        <?php if(!empty($val['res_3'])){ ?>
                                        <span>差旅人口<?php echo $val['travel_3']; ?>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
