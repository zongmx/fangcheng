                        ...
                        <script>
                            $(function() {
                                ...
                                charBaseOnD3.createLine( {
                                    ...
                                    series:"/details/slot/id/1/mall_id/<?php  echo $mall_id?>/popular_type/<?php echo $args?>"
                                } );
                            })
                        </script>
                    </div>
...
<script>
    function next(page){
      $.ajax({
            type:"post",
            url:"/details/slot/id/22/mall_id/<?php echo $mall_id?>/popular_type/<?php echo $args?>/page/"+page,
            dataType:'html',
            success:function(e){
                $("#main_index_0").html(e);
                $("body").trigger( "create" );
...
<script>
    function changeperiod(data){ 
      ...
      $.ajax({
            type:"post",
            url:'/details/slot/id/22/mall_id/<?php echo $mall_id?>/popular_type/'+$(data).val(),
            dataType:'html',
            success:function(e){
                $("#main_index_0").html(e);
                $("body").trigger( "create" );
