...
return [
    ...
    // 代码版本号
    'VERSION'          =>  '1.4.1314',        # 用于清除前端CSS,JS缓存
    ...
    # 网站URL设置
    'WEB_URL'          => 'http://fangcheng',                      # 网站访问路径
    
    # 上传设置
    'UPLOAD_URL'       => 'http://fangcheng/upload',              # 访问上传文件的url
...
// 		    'pwd' => '$Oi0iwFa7',
    ...
    // 微信配置
    'WeiXin'    =>  [
		'appId'     =>  'wx5fc2480bad53e09f',
		'appSecret' =>  '6d8b5bead2358d755b7b81cea3dcb2e2',
	],
